...
//  CryptoTracker
//
//  Created by Tyler Aguirre on 3/20/22.
//
...
extension SettingsView {
    ...
    private var swiftfulThinkingSection: some View {
        Section(header: Text("Swiftful Thinkins")) {
        ...
        Section(header: Text("Developer")) {
            VStack(alignment: .leading) {
                Image("logo")
                    ...
                    .frame(width: 100, height: 100)
                    .clipShape(RoundedRectangle(cornerRadius: 20))
                Text("This app was developed by Tyler Aguirre. It uses SwiftUI and is written 100% in Swift. The project benefits from multi-threading, publishers/subscribers, and data persistance.")
                    .font(.callout)
                    .fontWeight(.medium)
                    .foregroundColor(Color.theme.accent)
            }
