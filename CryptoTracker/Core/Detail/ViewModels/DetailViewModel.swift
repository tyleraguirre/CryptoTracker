...
class DetailViewModel: ObservableObject {
    ...
    private func mapDataToStatistics(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> (overview: [StatisticModel], additional: [StatisticModel]) {
        ...
        let addtionalArray = createAdditionalArray(coinModel: coinModel, coinDetailModel: coinDetailModel)
   ...
   private func createOverviewArray(coinModel: CoinModel) -> [StatisticModel] {
        ...
        let marketCapStat = StatisticModel(title: "Market Capitialization", value: marketCap, percentageChange: marketCapPercentChange)
  ...
  private  func createAdditionalArray(coinModel: CoinModel, coinDetailModel: CoinDetailModel?) -> [StatisticModel] {
        ...
        let addtionalArray: [StatisticModel] = [highStat, lowStat, priceChangeStat, marketCapChangeStat, blockStat, hasingStat]
